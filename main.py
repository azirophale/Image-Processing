...
image = 'green_matrix_code.jpg'

# Path of our caffemodel, prototxt, and numpy files
prototxt = "./colorization_deploy_v2.prototxt"

# The File in 122 MB so cannot add it in Git.Here is the drive link
# https://drive.google.com/file/d/1SWbUMm9TWCVT0otVxD2H5i4KLQ8nMQov/view?usp=sharing
...
cv2.imwrite("./Colored"+image, RGB_BGR)